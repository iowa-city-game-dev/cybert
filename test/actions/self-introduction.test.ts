...
describe('SelfIntroduction', () => {
  ...
  let selfIntroduction: SelfIntroduction;
  ...
  beforeEach(() => {
    ...
    selfIntroduction = new SelfIntroduction(mockLogger, mockConstants, mockDialogUtils, mockMessageUtils);
  });
  ...
  describe('welcomeNewMember', () => {
    ...
    it('should use MessageUtils.sendMessages to send the correct sequence of introduction messages', () => {
      selfIntroduction.introduceSelf(mockGuild);
